...
When the dashboard opens, it should display the Project Pulse UI from `app/index.html`, not a server directory listing. The launch configuration should serve from the `app/` directory and open `index.[...]
